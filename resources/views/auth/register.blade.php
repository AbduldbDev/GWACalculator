                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <input type="text" id="form3Example1c"
                                                    ...
                                                    autocomplete="off" placeholder="Name" style="border-radius:25px ;" />
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <input type="email" id="form3Example3c"
                                                    ...
                                                    placeholder="Email" style="border-radius:25px ;" required />
                                                @error('email')
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <input type="password" id="form3Example4c"
                                                    ...
                                                    placeholder="Confrim Password" style="border-radius:25px ;" />
                                            </div>
                                        </div>
